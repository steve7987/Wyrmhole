...
bool LightShader::Initialize(ID3D11Device* device, HWND hwnd){
	...
	if (!InitializeShader(device, hwnd, LIGHTSHADERFILEVS, LIGHTSHADERFILEPS)){
		return false;
	}
...
bool LightShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename){
	...
	result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "LightVertexShader", "vs_4_0", 
	...
	result = D3DX11CompileFromFile(psFilename, NULL, NULL, "LightPixelShader", "ps_4_0",
