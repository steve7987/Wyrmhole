...
//using version 4.0 for shader and enabled backwards compat
...
bool TextureShader::Initialize(ID3D11Device* device, HWND hwnd){
	...
	if (!InitializeShader(device, hwnd, TEXTURESHADERFILENAMEVS, TEXTURESHADERFILENAMEPS)){
		return false;
	}
...
bool TextureShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename){
	...
	result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "TextureVertexShader", "vs_4_0", 
	...
	result = D3DX11CompileFromFile(psFilename, NULL, NULL, "TexturePixelShader", "ps_4_0",
...
void TextureShader::ShutdownShader(){
	//release the five instances that were created in init
