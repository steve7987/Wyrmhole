...
bool TrackTube::InitializeBuffers(ID3D11Device * device, float repeat){
	...
	//setup vertex info
	double seglength = 1.0 / NUMTUBESEGMENTS * repeat;
	double curlength = 0;
	for (int i = 0; i < NUMTUBESEGMENTS; i++){
		for (int k = 0; k < TUBESIDES - 1; k++){
			...
			vertices[6*(TUBESIDES*i + k) + 0].texture = D3DXVECTOR2((float)(curlength), (1.0f*k)/TUBESIDES);
			...
			vertices[6*(TUBESIDES*i + k) + 1].texture = D3DXVECTOR2((float)((curlength+seglength)), (1.0f*k)/TUBESIDES);
			...
			vertices[6*(TUBESIDES*i + k) + 2].texture = D3DXVECTOR2((float)(curlength), (1.0f*(k+1))/TUBESIDES);
			...
			vertices[6*(TUBESIDES*i + k) + 3].texture = D3DXVECTOR2((float)(curlength), (1.0f*(k+1))/TUBESIDES);
			...
			vertices[6*(TUBESIDES*i + k) + 4].texture = D3DXVECTOR2((float)((curlength+seglength)), (1.0f*k)/TUBESIDES);
			...
			vertices[6*(TUBESIDES*i + k) + 5].texture = D3DXVECTOR2((float)((curlength+seglength)), (1.0f*(k+1))/TUBESIDES);
		...
		vertices[6*(TUBESIDES*i + TUBESIDES - 1) + 0].texture = D3DXVECTOR2((float)(curlength), (1.0f*(TUBESIDES - 1))/TUBESIDES);
		...
		vertices[6*(TUBESIDES*i + TUBESIDES - 1) + 1].texture = D3DXVECTOR2((float)((curlength+seglength)), (1.0f*(TUBESIDES - 1))/TUBESIDES);
		...
		vertices[6*(TUBESIDES*i + TUBESIDES - 1) + 2].texture = D3DXVECTOR2((float)(curlength), 1.0f);
		...
		vertices[6*(TUBESIDES*i + TUBESIDES - 1) + 3].texture = D3DXVECTOR2((float)(curlength), 1.0f);
		...
		vertices[6*(TUBESIDES*i + TUBESIDES - 1) + 4].texture = D3DXVECTOR2((float)((curlength+seglength)), (1.0f*(TUBESIDES - 1))/TUBESIDES);
		...
		vertices[6*(TUBESIDES*i + TUBESIDES - 1) + 5].texture = D3DXVECTOR2((float)((curlength+seglength)), 1.0f);
